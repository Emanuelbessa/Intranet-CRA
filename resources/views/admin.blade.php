                ...
                @foreach($users as $user)
                  <tr>
                    <form action="{{ route('admin.assign') }}" method="post">
                        ...
                        <td><input type="checkbox" {{ $user->hasRole('Comunicacao') ? 'checked' : '' }} name="role_comunicacao"></td>
                        <td><input type="checkbox" {{ $user->hasRole('Financeiro') ? 'checked' : '' }} name="role_financeiro"></td>
                        <td><input type="checkbox" {{ $user->hasRole('RH') ? 'checked' : '' }} name="role_rh"></td>
                        <td><input type="checkbox" {{ $user->hasRole('Atendente') ? 'checked' : '' }} name="role_atendente"></td>
                        {{ csrf_field() }}
