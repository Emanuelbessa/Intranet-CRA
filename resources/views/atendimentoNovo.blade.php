            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="cpfcnpjprincipal" placeholder="CPF/CNPJ"
                    name="cpfcnpjprincipal">
                </div>
                <div class="form-check">
                ...
                <div class="form-group" id="nomerepresentante">
                  ...
                  <input type="text" class="form-control" id="nomerepresentante" placeholder="Nome"
                    name="nomerepresentante">
                </div>
                <div class="form-group" id="cpfrepresentante">
                  <label for="exampleInputPassword1">CPF do Representante</label>
                  <input type="text" class="form-control" id="cpfcnpjrepresentante" placeholder="CPF/CNPJ"
                    name="cpfcnpjrepresentante">
                </div>
              </div>
            </div>
            <!-- /.card -->
        ...
        <div class="card card-info">
          ...
          <div class="card-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="outrosmotivos" id="outrosmotivos"
